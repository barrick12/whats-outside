...
module.exports = function(app) {
  ...
  app.post('/api/getVenues', cors(corsOptions), jsonParser, async function(req,res) {
    ...
    try {
      const responseSearch = await fetch(`https://api.foursquare.com/v2/venues/search?client_id=${configValues.clientId}&client_secret=${configValues.clientSecret}&limit=10&near=${decodeURI(req.body.location)}&intent=browse&radius=2000&v=20180323`, 
      { 
        method: 'GET',
        cache: 'no-cache',            
      });
